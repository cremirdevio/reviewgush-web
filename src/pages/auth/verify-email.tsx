...
export default function VerifyEmail() {
  ...
  return (
    <AuthLayout>
      ...
      <Container textAlign={"center"} shadow={["none", "2xl"]} w={["full", "3xl"]} maxW={"3xl"} bg={"whiteAlpha.900"} borderRadius={["none", "3xl"]} height={["full", "fit-content"]} px={["24px", "48px"]} py={["48px"]}>
        {/* Logo Here */}
        <Link href='/'>
          <Center>
        ...
        <Heading fontWeight={"normal"} fontSize={["2xl"]}>Verify your account</Heading>
