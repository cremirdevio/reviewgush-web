import { Avatar, Badge, Checkbox, Flex, HStack, Td, Text, Tr, VStack } from '@chakra-ui/react'
...
export default function SingleReviewTableItem() {
  return (
    ...
    <Td>
        <HStack maxW={"15rem"}>
            <Avatar name="Joseph Ajibodu" src="https://avatars.githubusercontent.com/u/78092933?v=4" size={"md"} />
